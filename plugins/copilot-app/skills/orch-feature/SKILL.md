...
Execute a feature implementation workflow from approved requirements through local
validation using canvas interface.
...
- Call `start_run` with `skillId: "orch-feature"` and these stages: Implementation,
  Build & Test, QA Validation, Personal Validation, Create Pull Request, Summary.
