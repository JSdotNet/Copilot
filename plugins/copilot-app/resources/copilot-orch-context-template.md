...
<!--
Copy this file to `.github/copilot-orch-context.md` in your repository and fill it in.
...
Never pin a model here — model choice belongs in `.github/copilot-model-selection.md`.
Convention: plugins/copilot-app/instructions/orch-repo-context.instructions.md
-->
