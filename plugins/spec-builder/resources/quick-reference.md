...
| Path-specific instructions | `.github/instructions/*.instructions.md` | Rules that apply only to specific file paths or asset types | Both — `applyTo` for Copilot, a `.claude/rules/` mirror with `paths` for Claude (repository only) |
