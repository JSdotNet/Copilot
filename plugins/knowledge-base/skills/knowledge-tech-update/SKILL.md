...
From a repository that installed the knowledge-base tools:
...
```bash
node plugins/knowledge-base/tools/knowledge-tech/dotnet-packages.mjs --root .
node plugins/knowledge-base/tools/knowledge-tech/frontend-packages.mjs --root .
```
