export const meta = {
  ...
  whenToUse:
    'Invoked by the workflow-issue-sweep skill with the fetched issue list and the open-work surface. Returns relevance verdicts and conflict verdicts; it decides nothing and writes nothing.',
  phases: [
...
if (!args || !args.repo || !Array.isArray(args.issues)) {
  throw new Error('triage.workflow.js requires args.repo and args.issues[]. Invoke it through the workflow-issue-sweep skill.')
}
