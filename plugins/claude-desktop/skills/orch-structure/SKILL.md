...
- During **Structure & Architecture Intake** or **Refactor Planning**, optionally
  open/update the `render_markdown` dashboard tool with the recorded structure plan and
  the `render_diagram` dashboard tool with any accompanying layout diagram, per
...
Source skill location: `plugins/claude-desktop/skills/orch-structure/SKILL.md`
