---
name: orch-blueprint
description: 'Orchestrate architecture blueprint creation or refresh with the Claude Code orchestration dashboard. Uses the architecture:architect agent for blueprint work and `jsdotnet-guidelines-mcpserver` to ground governed asset changes in project guidance.'
---

# Orchestrate Architecture Blueprint

Execute a blueprint workflow with the Claude Code orchestration dashboard with MCP-guided context gathering up front and architecture drafting delegated to the architect agent.
...
- System: "Claude Code plugin ecosystem"
...
- During **Blueprint Drafting**, also open/update the `render_markdown` dashboard tool
  with the drafted blueprint content, per `instructions/dashboard-usage.instructions.md`.
...
Source skill location: `plugins/claude-desktop/skills/orch-blueprint/SKILL.md`
