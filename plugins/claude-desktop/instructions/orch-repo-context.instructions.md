...
description: Defines the optional .claude/orch-context.md convention a consuming repository uses to declare how its application starts, where to validate it, and how deep QA should go, so orchestrations do not have to guess or ask.
---
...
- A consuming repository may create `.claude/orch-context.md` at its repo root.
